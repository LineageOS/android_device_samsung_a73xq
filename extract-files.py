...
blob_fixups: blob_fixups_user_type = {
    'vendor/lib64/hw/com.qti.chi.override.so': blob_fixup()
        .sig_replace(
            '80 06 40 F9 E5 78 00 94 80 01 00 34 82 DB FF D0 A3 DD FF F0 A5 DC FF 90 E6 03 00 2A',
            '1F 20 03 D5 1F 20 03 D5 1F 20 03 D5 1F 20 03 D5 1F 20 03 D5 1F 20 03 D5 1F 20 03 D5'
        )
        .sig_replace(
            '42 DC 0F 91 63 74 13 91 A5 A8 1C 91 A4 11 80 52 E0 03 1F 2A 21 00 80 52 8D FE FF 97 80 06 40 F9',
